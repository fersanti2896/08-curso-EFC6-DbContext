...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.CineDetalle", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Mercancia", b =>
                {
                    b.HasBaseType("PeliculasWebAPI.Entidades.Producto");

                    b.Property<bool>("DisponibleInventario")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("Mercancia", (string)null);
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.PagoPaypal", b =>
                {
                    b.HasBaseType("PeliculasWebAPI.Entidades.Pago");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            FechaTransaccion = new DateTime(2022, 5, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Monto = 9.99m,
                            TipoPago = 1,
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.PagoTarjeta", b =>
                {
                    b.HasBaseType("PeliculasWebAPI.Entidades.Pago");

                    b.Property<string>("FourDigits")
                        .IsRequired()
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.PeliculaAlquilable", b =>
                {
                    b.HasBaseType("PeliculasWebAPI.Entidades.Producto");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Actor", b =>
                {
                    b.OwnsOne("PeliculasWebAPI.Entidades.Direccion", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("PeliculasWebAPI.Entidades.Direccion", "DireccionHogar", b1 =>
                        {
                            b1.Property<int>("ActorId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Cine", b =>
                {
                    b.OwnsOne("PeliculasWebAPI.Entidades.Direccion", "Direccion", b1 =>
                        {
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.CineDetalle", b =>
                {
                    b.HasOne("PeliculasWebAPI.Entidades.Cine", "Cine")
                        .WithOne("CineDetalle")
                        .HasForeignKey("PeliculasWebAPI.Entidades.CineDetalle", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Mercancia", b =>
                {
                    b.HasOne("PeliculasWebAPI.Entidades.Producto", null)
                        .WithOne()
                        .HasForeignKey("PeliculasWebAPI.Entidades.Mercancia", "Id")
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.PeliculaAlquilable", b =>
                {
                    b.HasOne("PeliculasWebAPI.Entidades.Producto", null)
                        .WithOne()
                        .HasForeignKey("PeliculasWebAPI.Entidades.PeliculaAlquilable", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
